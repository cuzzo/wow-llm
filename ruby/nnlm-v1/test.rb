...
require 'cmath'          # For tanh verification if needed
require 'set'            # Required by nnlm.rb

require 'byebug'

# Make sure these paths are correct relative to where you run the test
require_relative 'tokenizer' # Our dummy or real tokenizer
require_relative 'llm'       # Your NNLM class file
